# pll_simple_example.gnu : configuration for output plot
...
plot 'pll_simple_example.dat' using 1:2 with lines lt 1 lw 2 lc rgb '#999999' notitle ,\
     'pll_simple_example.dat' using 1:4 with lines lt 1 lw 2 lc rgb '#802080' notitle

# imag
set ylabel 'imag'                       # set y-axis label
set yrange [-1.2:1.2]                   # set plot range
plot 'pll_simple_example.dat' using 1:3 with lines lt 1 lw 2 lc rgb '#999999' notitle ,\
     'pll_simple_example.dat' using 1:5 with lines lt 1 lw 2 lc rgb '#004080' notitle

# phase error
set ylabel 'phase error'                # set y-axis label
set yrange [-3.2:3.2]                   # set plot range
plot 'pll_simple_example.dat' using 1:6 with lines lt 1 lw 3 lc rgb '#804017' notitle
